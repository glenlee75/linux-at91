...
#define HOST_IF_MSG_DEL_ALL_RX_BA_SESSIONS		((NMI_Uint16)37)

#ifdef NMC1000_BT_COEXISTENCE
#define HOST_IF_MSG_CHANGE_BT_COEX_MODE	((NMI_Uint16)38)
#endif
...
#ifdef NMC1000_BT_COEXISTENCE
static NMI_Sint32 Handle_BTCoexModeChange(void * drvHandler, tstrHostIFBTCoexMode* pstrHostIFBTCoexMode)
{
	...
	/*prepare configuration packet*/
	strWID.u16WIDid = (NMI_Uint16)WID_BT_COEX_MODE;
	strWID.enuWIDtype= WID_CHAR;
	strWID.ps8WidVal = (NMI_Char*)&(pstrHostIFBTCoexMode->u8BTCoexMode);
	strWID.s32ValueSize = sizeof(NMI_Char);
...
static int Handle_RemainOnChan(void* drvHandler,tstrHostIfRemainOnChan* pstrHostIfRemainOnChan)
{
	...
	strWID.ps8WidVal =(NMI_Sint8*)NMI_MALLOC(strWID.s32ValueSize);

	if(strWID.ps8WidVal == NMI_NULL)
	{
		NMI_ERRORREPORT(s32Error,NMI_NO_MEM);
	}

	strWID.ps8WidVal[0]=u8remain_on_chan_flag;
	strWID.ps8WidVal[1]=(NMI_Sint8)pstrHostIfRemainOnChan->u16Channel;
...
*  @version		9.0
*/
static NMI_Sint32 Handle_DelAllRxBASessions(void * drvHandler, tstrHostIfBASessionInfo* strHostIfBASessionInfo)
{
	NMI_Sint32 s32Error = NMI_SUCCESS;
	tstrWID strWID;
	char* ptr = NULL;
	...
	strWID.u16WIDid = (NMI_Uint16)WID_DEL_ALL_RX_BA;
	strWID.enuWIDtype = WID_STR;
	strWID.ps8WidVal = (NMI_Uint8*)NMI_MALLOC(BLOCK_ACK_REQ_SIZE);
	strWID.s32ValueSize = BLOCK_ACK_REQ_SIZE;
	ptr = strWID.ps8WidVal;
...
#ifdef NMC1000_BT_COEXISTENCE
NMI_Sint32 host_int_change_bt_coex_mode(NMI_WFIDrvHandle hWFIDrv,NMI_Uint8 u8BtCoexMode)
{
	NMI_Sint32 s32Error = NMI_SUCCESS;
	tstrNMI_WFIDrv * pstrWFIDrv = (tstrNMI_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
...
*  @version		1.0
*/
NMI_Sint32 host_int_remain_on_channel(NMI_WFIDrvHandle hWFIDrv, NMI_Uint32 u32SessionID, NMI_Uint32 u32duration, NMI_Uint16 chan,tNMIpfRemainOnChanExpired RemainOnChanExpired, tNMIpfRemainOnChanReady RemainOnChanReady,void* pvUserArg)
{
	NMI_Sint32 s32Error = NMI_SUCCESS;
	tstrNMI_WFIDrv * pstrWFIDrv = (tstrNMI_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
...
*  @version		1.0
*/
NMI_Sint32 host_int_ListenStateExpired(NMI_WFIDrvHandle hWFIDrv, NMI_Uint32 u32SessionID)
{
	NMI_Sint32 s32Error = NMI_SUCCESS;
	tstrNMI_WFIDrv * pstrWFIDrv = (tstrNMI_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
...
NMI_Sint32 host_int_delBASession(NMI_WFIDrvHandle hWFIDrv, char* pBSSID,char TID)
{
	NMI_Sint32 s32Error = NMI_SUCCESS;
	tstrNMI_WFIDrv * pstrWFIDrv = (tstrNMI_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
...
NMI_Sint32 host_int_del_All_Rx_BASession(NMI_WFIDrvHandle hWFIDrv, char* pBSSID,char TID)
{
	NMI_Sint32 s32Error = NMI_SUCCESS;
	tstrNMI_WFIDrv * pstrWFIDrv = (tstrNMI_WFIDrv *)hWFIDrv;
	tstrHostIFmsg strHostIFmsg;
