...
#ifdef NMI_P2P
typedef void(*tNMIpfRemainOnChanExpired)(void*, NMI_Uint32);	/*Remain on channel expiration callback function*/
...
/*!
 *  @fn		NMI_Sint32 host_int_setup_multicast_filter(NMI_WFIDrvHandle hWFIDrv, NMI_Bool bIsEnabled, NMI_Uint8 u8count)
