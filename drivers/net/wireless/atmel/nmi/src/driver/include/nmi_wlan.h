...
#define ISNMC3000(id)   (((id & 0xfffff000) == 0x300000) ? 1 : 0) 
...
#define rFILTER_WIFI_LOGS_BIT        (5)

#define NMI_HAVE_SDIO_IRQ_GPIO       (1 << rHAVE_SDIO_IRQ_GPIO_BIT)
#define NMI_HAVE_USE_PMU             (1 << rHAVE_USE_PMU_BIT)
#define NMI_HAVE_SLEEP_CLK_SRC_RTC   (1 << rHAVE_SLEEP_CLK_SRC_RTC_BIT)
#define NMI_HAVE_SLEEP_CLK_SRC_XO    (1 << rHAVE_SLEEP_CLK_SRC_XO_BIT)
#define NMI_HAVE_EXT_PA_INV_TX_RX    (1 << rHAVE_EXT_PA_INV_TX_RX_BIT)
#define NMI_FILTER_WIFI_LOGS         (1 << rFILTER_WIFI_LOGS_BIT)
#define NMI_XTAL_24 				(1 << 6)
#define NMI_DISABLE_NMC_UART 		(1 << 7)
